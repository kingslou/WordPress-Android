 ...
 * The theme browser.
 */
public class ThemeBrowserActivity2 extends AppCompatActivity implements
        ...
        WordPress.getRestClientUtils().getThemes(siteId, 0, 0, new Listener() {
                    ...
                    public void onErrorResponse(VolleyError response) {
                        if (response.toString().equals(AuthFailureError.class.getName())) {
                            ...
                            Toast.makeText(ThemeBrowserActivity2.this, R.string.theme_fetch_failed, Toast.LENGTH_LONG)
                                    .show();
    ...
    public void onThemeSelected(String themeId) {
        ...
        if (!DisplayUtils.isXLarge(ThemeBrowserActivity2.this)) {
        ...
        protected void onPostExecute(final ArrayList<Theme> result) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    mFetchingThemes = false;
                    if (result == null) {
                        Toast.makeText(ThemeBrowserActivity2.this, R.string.theme_fetch_failed, Toast.LENGTH_SHORT)
                             .show();
                    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        if (DisplayUtils.isXLarge(ThemeBrowserActivity2.this) && mDetailsFragment != null) {
    ...
    public void onActivateThemeClicked(String themeId, final Fragment fragment) {
        ...
        final WeakReference<ThemeBrowserActivity2> ref = new WeakReference<ThemeBrowserActivity2>(this);
        ...
        WordPress.getRestClientUtils().setTheme(siteId, themeId, new Listener() {
                    ...
                    public void onResponse(JSONObject arg0) {
                        ...
                        Toast.makeText(ThemeBrowserActivity2.this, R.string.theme_set_success, Toast.LENGTH_LONG).show();
